...
- Updated: 2026-09-03T08:49:19.736Z

## Dependency edges
- IMPORT index.html -> styles.css, script.js
- IMPORT pages/about.html -> styles.css, script.js
- IMPORT pages/brands.html -> styles.css, script.js
- IMPORT pages/collections.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/3d-wall-stone-cladding.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/cement-flooring-designer-tiles.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/chandeliers.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/designer-fans-kitchen-appliances.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/furniture.html -> styles.css, script.js
- IMPORT pages/COLLECTIONS/modular-kitchen.html -> styles.css, script.js
...
## Database references
- DB script.js -> an, every, view

## Symbols
- SYMBOL script.js: initLoader, animateCounter, tick, showRevealItem, initStorySlider, renderSlide, goToSlide, initServices, setFeatured, watchRevealItems

## UI/style selectors
- UI index.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #about, #collections, #services, #story, #brands, #process, #enquiry, #contact
- UI pages/about.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #about, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .loader, .loader__content
- UI pages/brands.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #brands, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .brands-page, .loader
- UI pages/collections.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #collections, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .collections-page, .loader
- UI pages/COLLECTIONS/3d-wall-stone-cladding.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #3d-wall-stone-cladding, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .collection-page, .chandelier-page
- UI pages/COLLECTIONS/cement-flooring-designer-tiles.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #cement-flooring-designer-tiles, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .collection-page, .chandelier-page
- UI pages/COLLECTIONS/chandeliers.html: #loader, #loader-content, #page-wrapper, #sidebar-overlay, #sidebar, #sidebar-close, #chandeliers, #enquiry, #contact, #enquiry-popup, #enquiry-popup-title, .about-page, .collection-page, .chandelier-page
