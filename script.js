...
const serviceItems = [
  ...
  },
  {
    ...
    alt: "Luxury living room with curated décor and artful details",
  },
];
...
// ─── COLLECTION CARD CLICK DELEGATION ─────────────────────────────────────────

function initCollectionCardClicks() {
  const cards = document.querySelectorAll(".collections__grid article, .collections__card");
  cards.forEach((card) => {
